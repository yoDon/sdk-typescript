...
import { CancellationScope, newActivityStub } from '@temporalio/workflow';
import type * as activities from '../activities';
import { Returner } from '../interfaces';

const { httpGetJSON } = newActivityStub<typeof activities>({ type: 'remote', startToCloseTimeout: '10m' });
